								...
								<div class="form-group row mb-0">
									<div class="col-md-12">
										...
										<fieldset class="form-group mb-0 d-flex barcodeselection">
											...
											<input list="browsers" type="text" class="form-control border-dark" id="basicInput1" placeholder="">
									...
									<tbody>
									  ...
									  <tr class="d-flex align-items-center justify-content-between">
										<th class="border-0">
											<div class="d-flex align-items-center font-size-h5 mb-0 font-size-bold text-dark">
										    Shipping Cost
												<span class="badge badge-secondary white rounded-circle ms-2"  data-bs-toggle="modal" data-bs-target="#shippingcost">
